...
public final class LicenseConfig {
    ...
    /**
     * URL of the bot's /verify endpoint (see bot/README.md "Deploying the API
     * publicly"). Must be reachable from players' machines, so this can't be
     * localhost — fill it in once the bot is hosted somewhere public.
     */
